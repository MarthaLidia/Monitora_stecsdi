...
part of ec.gob.infancia.ecuadorsincero.forms.module05.people;
...
class FormPeopleBloc extends BaseBloc<FormPeopleBlocState> {
  ...
  onLoad() async {
    ...
    FormUtils.setQuestions(
      state: state,
      formId: formId,
      params: ['r', Module05Constants.moduleId],
      action: (questionId) {
        if (questionId == 'r_05') {
  ...
  _handleLoadForm() {
    sqliteDB.query(
      ...
      whereArgs: [formId, 'r', 0, Module05Constants.moduleId],
      ...
      sqliteDB.query(
        ...
        whereArgs: [formId, 'h_36', Module05Constants.moduleId],
      ).then((answersDb) {
      ...
      sqliteDB.query(
        ...
        whereArgs: [formId, 'h_10', 'h_11', 'h_12', Module05Constants.moduleId],
      ).then((answersDb) {
  ...
  _loadPeopleInfo() {
    ...
    sqliteDB.query(
      ...
      whereArgs: [formId, 'h_36', 0, Module05Constants.moduleId],
    ).then((answersDb) async {
      if (answersDb.isEmpty) {
        return;
      }
  ...
  _handleQuestionChange(
    ...
    if (question == 'r_07' || question=='r_07_1') {
      print("camara");
  ...
  _handleRemovePerson(int code) async {
    if (totalPeople > 1) {
      ...
      await sqliteDB.delete(
        ...
        whereArgs: [formId, code, Module05Constants.moduleId],
      );
