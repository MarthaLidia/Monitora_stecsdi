...
class FormHouseBloc extends BaseBloc<FormHouseBlocState> {
  ...
  onLoad() async {
    ...
    FormUtils.setQuestions(
      state: state,
      formId: id,
      params: ['hs_01', Module02Constants.moduleId],
      action: (questionId) {
        if (questionId == 'h_06' || questionId == 'h_07') {
          ...
          sqliteDB.update(
            ...
            whereArgs: [formHeader.id, Module02Constants.moduleId],
          );
        }
        if (questionId == 'h_15' &&
  ...
  _handleNewForm() async {
    ...
    formHeader = ModelFormHeader(
      ...
      moduleName: Module02Constants.moduleName,
  ...
  _handleEditForm() {
    ...
    sqliteDB.query(
      ...
      var answersDb = await sqliteDB.query(
        ...
        whereArgs: [formHeader.id, 'hs_01', code, Module02Constants.moduleId],
      );
