...
part of ec.gob.infancia.ecuadorsincero.forms.module03.woman;
...
class FormWomanBloc extends BaseBloc<FormWomanBlocState> {
  ...
  onLoad() async {
    ...
    FormUtils.setQuestions(
      ...
      params: ['ms_01', 'ms_02', Module03Constants.moduleId],
      code: code,
      action: (questionId) {},
    );
  ...
  _handleLoadForm() {
    ...
    sqliteDB.query(
      ...
      whereArgs: [formId, code, 'ms_01', 'ms_02', Module03Constants.moduleId],
    ).then((answersDb) {
